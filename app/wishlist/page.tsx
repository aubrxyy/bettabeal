        ...
        <div className="flex-grow flex flex-col lg:flex-row mx-auto mb-20">
          <div className="w-full px-4">
            ...
            {wishlistItems.length === 0 ? (
              <div className="flex justify-center mx-16 md:mx-48 lg:mx-64 xl:mx-72 items-center my-12 text-nowrap">
                <p className="text-lg text-gray-500 italic">No items currently in wishlist.</p>
              </div>
            ) : (
